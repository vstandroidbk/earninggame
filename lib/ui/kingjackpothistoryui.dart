...
class KingJackpotHistory extends StatefulWidget {
  const KingJackpotHistory({super.key});

  @override
  State<KingJackpotHistory> createState() => _KingJackpotHistoryState();
}

class _KingJackpotHistoryState extends State<KingJackpotHistory> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("King Jackpot History"),
      ),
      body: SafeArea(
          child: Column(
        children: [
