...
class KingJackpotResultHistoryUi extends StatefulWidget {
  ...
  @override
  State<KingJackpotResultHistoryUi> createState() =>
      _KingJackpotResultHistoryUiState();
}

class _KingJackpotResultHistoryUiState
    extends State<KingJackpotResultHistoryUi> {
  ...
  void initState() {
    ...
    Provider.of<GaliProvider>(context, listen: false)
        .jackpotResultApicall(context, selectedDate ?? dateToday);
  }
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        children: [
          ...
          Expanded(child: Consumer<GaliProvider>(
            builder: (context, galiProvider, child) {
              List<GameResult>? dataList =
                  galiProvider.jackpotResultData.gameResult;
              return galiProvider.isJsckpotResultLonding
                  ? const CustomCircularProgress()
                  : galiProvider.jackpotResultData.status == false
                      ? const Center(
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            GameResult? data = dataList?[index];
                            return Container(
