...
class PenalGroupGameUi extends StatefulWidget {
  const PenalGroupGameUi({super.key});

  @override
  State<PenalGroupGameUi> createState() => _PenalGroupGameUiState();
}

class _PenalGroupGameUiState extends State<PenalGroupGameUi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarComman(const Text("Penal Group Game")),
      body: Column(
        children: [
          Container(
