...
class DpMotorGameUi extends StatefulWidget {
  const DpMotorGameUi({super.key});

  @override
  State<DpMotorGameUi> createState() => _DpMotorGameUiState();
}

class _DpMotorGameUiState extends State<DpMotorGameUi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarComman(const Text("Dp Motor Game")),
      body: Column(
        children: [
          Container(
