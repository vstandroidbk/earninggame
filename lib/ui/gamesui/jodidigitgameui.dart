...
class JodiDigitGameUi extends StatefulWidget {
  const JodiDigitGameUi({super.key});

  @override
  State<JodiDigitGameUi> createState() => _JodiDigitGameUiState();
}

class _JodiDigitGameUiState extends State<JodiDigitGameUi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarComman(const Text("Jodi Digit Game")),
      body: Column(
        children: [
          Container(
