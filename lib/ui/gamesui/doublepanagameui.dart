...
class DoublePanaGameUi extends StatefulWidget {
  const DoublePanaGameUi({super.key});

  @override
  State<DoublePanaGameUi> createState() => _DoublePanaGameUiState();
}

class _DoublePanaGameUiState extends State<DoublePanaGameUi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarComman(const Text("Double Pana Game")),
      body: Column(
        children: [
          Container(
