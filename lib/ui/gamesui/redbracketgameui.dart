...
class RedBracketsGameUi extends StatefulWidget {
  const RedBracketsGameUi({super.key});

  @override
  State<RedBracketsGameUi> createState() => _RedBracketsGameUiState();
}

class _RedBracketsGameUiState extends State<RedBracketsGameUi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarComman(const Text("Red Brackets Game")),
      body: Column(
        children: [
          Container(
