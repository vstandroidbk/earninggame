...
class GroupJodiGameUi extends StatefulWidget {
  const GroupJodiGameUi({super.key});

  @override
  State<GroupJodiGameUi> createState() => _GroupJodiGameUiState();
}

class _GroupJodiGameUiState extends State<GroupJodiGameUi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarComman(const Text("Group Jodi Game")),
      body: Column(
        children: [
          Container(
