...
class SinglePanaGameUi extends StatefulWidget {
  const SinglePanaGameUi({super.key});

  @override
  State<SinglePanaGameUi> createState() => _SinglePanaGameUiState();
}

class _SinglePanaGameUiState extends State<SinglePanaGameUi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarComman(const Text("Single Pana Game")),
      body: Column(
        children: [
          Container(
