...
class SinglePanaBulkGameUi extends StatefulWidget {
  const SinglePanaBulkGameUi({super.key});

  @override
  State<SinglePanaBulkGameUi> createState() => _SinglePanaBulkGameUiState();
}

class _SinglePanaBulkGameUiState extends State<SinglePanaBulkGameUi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: appBarComman(const Text("Single Pana bulk Game")),
      body: Column(
        children: [
          Container(
