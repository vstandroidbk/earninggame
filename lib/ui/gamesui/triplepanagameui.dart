...
class TriplePanaGameUi extends StatefulWidget {
  const TriplePanaGameUi({super.key});

  @override
  State<TriplePanaGameUi> createState() => _TriplePanaGameUiState();
}

class _TriplePanaGameUiState extends State<TriplePanaGameUi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarComman(const Text("Triple Pana Game")),
      body: Column(
        children: [
          Container(
