...
class SpMotorGameUi extends StatefulWidget {
  const SpMotorGameUi({super.key});

  @override
  State<SpMotorGameUi> createState() => _SpMotorGameUiState();
}

class _SpMotorGameUiState extends State<SpMotorGameUi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarComman(const Text("Sp Motor Game")),
      body: Column(
        children: [
          Container(
