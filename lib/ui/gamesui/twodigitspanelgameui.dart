...
class TwoDigitsPanelGameUi extends StatefulWidget {
  const TwoDigitsPanelGameUi({super.key});

  @override
  State<TwoDigitsPanelGameUi> createState() => _TwoDigitsPanelGameUiState();
}

class _TwoDigitsPanelGameUiState extends State<TwoDigitsPanelGameUi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarComman(const Text("Two Digits Panel Game")),
      body: Column(
        children: [
          Container(
