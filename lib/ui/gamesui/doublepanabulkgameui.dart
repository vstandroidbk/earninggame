...
class DoublePanaBulkGameUi extends StatefulWidget {
  const DoublePanaBulkGameUi({super.key});

  @override
  State<DoublePanaBulkGameUi> createState() => _DoublePanaBulkGameUiState();
}

class _DoublePanaBulkGameUiState extends State<DoublePanaBulkGameUi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarComman(const Text("Double Pana bulk Game")),
      body: Column(
        children: [
          Container(
